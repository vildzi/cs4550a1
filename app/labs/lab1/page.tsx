  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe (BLT):
        <ol id="wd-your-favorite-recipe">
          <li>Chop up 2 leaves of lettuce</li>
          <li>Cut up 1 tomato into thin slices</li>
          <li>Cook bacon until crispy on medium heat</li>
          <li>Toast 2 slices of bread</li>
          <li>Spread mayonnaise on toasted bread slices</li>
          <li>Place bacon on bread slice</li>
          <li>Place lettuce and tomato on top of bacon</li>
          <li>Place other bread slice on top</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Hunger Games Mockingjay</li>
          <li>Harry Potter and the Chamber of Secrets</li>
          <li>From Crook to Cook</li>
        </ul>
      </div>
      <div id="wd-tables">
        <h4>Table Tag</h4>
